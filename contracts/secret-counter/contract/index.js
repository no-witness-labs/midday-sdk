...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    if (typeof(witnesses_0.provide_password) !== 'function') {
      throw new __compactRuntime.CompactError('first (witnesses) argument to Contract constructor does not contain a function-valued field named provide_password');
    }
      ...
      init: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('init',
                                     ...
                                     'secret-counter.compact line 13 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        ...
        const result_0 = this._init_0(context, partialProofData, hash_0);
      ...
      increment: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('increment',
                                     'argument 1 (as invoked from Typescript)',
                                     'secret-counter.compact line 19 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
      ...
      decrement: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('decrement',
                                     'argument 1 (as invoked from Typescript)',
                                     'secret-counter.compact line 25 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        if (!(typeof(amount_0) === 'bigint' && amount_0 >= 0n && amount_0 <= 65535n)) {
  ...
  _provide_password_0(context, partialProofData) {
    const witnessContext_0 = __compactRuntime.createWitnessContext(ledger(context.currentQueryContext.state), context.currentPrivateState, context.currentQueryContext.address);
    const [nextPrivateState_0, result_0] = this.witnesses.provide_password(witnessContext_0);
    context.currentPrivateState = nextPrivateState_0;
    if (!(result_0.buffer instanceof ArrayBuffer && result_0.BYTES_PER_ELEMENT === 1 && result_0.length === 32)) {
      __compactRuntime.typeError('provide_password',
                                 'return value',
                                 'secret-counter.compact line 10 char 1',
                                 'Bytes<32>',
                                 result_0)
    }
  ...
  _init_0(context, partialProofData, hash_0) {
  ...
  _increment_0(context, partialProofData, amount_0) {
    __compactRuntime.assert(this._equal_1(_descriptor_0.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                                    ...
                                                                                                    [
                                                                                                     ...
                                                                                                     { popeq: { cached: false,
                                                                                                                result: undefined } }]).value),
                                          this._persistentHash_0(this._provide_password_0(context,
                                                                                          partialProofData))),
                            'invalid password');
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
...
const _dummyContract = new Contract({
  provide_password: (...args) => undefined
});
